...
import AttributeAutocompleteEditing, { _toAttributeAutocompleteAttribute } from './attributeautocompleteediting.js';
import AttributeAutocompleteUI from './attributeautocompleteui.js';

import './theme/attributeautocomplete.css';
 ...
 */
export default class AttributeAutocomplete extends Plugin {
	/**
	 * Creates a attributeautocomplete attribute value from the provided view element and optional data.
	 *
	 *		editor.plugins.get( 'Mention' ).toMentionAttribute( viewElement, { userId: '1234' } );
	 *
	 *		// For a view element: <span data-attributeautocomplete="@joe">@John Doe</span>
	 *		// it will return:
	 ...
	 */
	static get requires() {
		return [ AttributeAutocompleteEditing, AttributeAutocompleteUI ];
	}
}

/**
 * The configuration of the {@link module:attributeautocomplete/mention~Mention} feature
 *
